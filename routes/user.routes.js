...
const { paginationSchema, usernameParamSchema, updateProfileSchema } = require('../validators/schemas');

router.post('/logout', authenticate, userController.logout);
router.put('/profile', authenticate, checkStatus, validate(updateProfileSchema), userController.updateProfile);
